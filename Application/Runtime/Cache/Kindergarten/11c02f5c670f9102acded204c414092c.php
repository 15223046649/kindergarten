...
<body>
<h3 style="text-align:left">家长通知列表</h3>
...
<?php if(is_array($snotice["list"])): foreach($snotice["list"] as $key=>$v): ?><td><?php echo ($v["stitle"]); ?></td>
<td><?php echo ($v["scomment"]); ?></td>
<td><p style="text-align:center"><?php echo ($v["stime"]); ?></p></td>

<td class="center"><a href="/newTeacher/Kindergarten/Snotice/revise/id/<?php echo ($v["id"]); ?>">修改</a>
<a href="/newTeacher/Kindergarten/Snotice/del/id/<?php echo ($v["id"]); ?>">删除</a>
...
$("select").change(function(){
	windows.location.href="/newTeacher/Kindergarten/Snotice/index/"+$(this).val();
});
$(function(){
	$("tr:odd").addClass("odd");
});
