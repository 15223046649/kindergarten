...
<body>
<h3 style="text-align:left">学生信息表</h3>
<form method="post" enctype="multipart/form-data" style="align:center">
<table  border="1" cellspacing="0px" >
<tr><th width="120"><p style="text-align:center">ID</p></th><th width="200"><p style="text-align:center">学生姓名</p></th>
<th width=""><p style="text-align:center">学生性别</p></th>
<th width=""><p style="text-align:center">所在班级</p></th>
<th width=""><p style="text-align:center">家长姓名</p></th>
<th width=""><p style="text-align:center">家长联系方式</p></th>
<th width=""><p style="text-align:center">操作</p></th>
</tr>
<?php if(is_array($student["list"])): foreach($student["list"] as $key=>$v): ?><td><?php echo ($v["Student_ID"]); ?></td>
<td><?php echo ($v["Student_NAME"]); ?></td>
<td><?php echo ($v["Student_SEX"]); ?></td>
<td><?php echo ($v["Student_CLA"]); ?></td>
<td><?php echo ($v["Student_PARN"]); ?></td>
<td><?php echo ($v["Student_PART"]); ?></td>
<td class="center"><a href="/newTeacher/Kindergarten/Student/revise/Student_ID/<?php echo ($v["Student_ID"]); ?>">修改</a>
<a href="/newTeacher/Kindergarten/Student/del/Student_ID/<?php echo ($v["Student_ID"]); ?>">删除</a></td></tr><?php endforeach; endif; ?>
</table>
<div class="pagelist"><?php echo ($goods["page"]); ?></div>
</div>
<script>
$("select").change(function(){
	windows.location.href="/newTeacher/Kindergarten/Student/index/"+$(this).val();
});
$(function(){
	$("tr:odd").addClass("odd");
});
