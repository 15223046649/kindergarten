...
<body>
<h3 style="text-align:left">家长意见表</h3>
<form method="post" enctype="multipart/form-data" style="align:center">
<table  border="1" cellspacing="0px" >
</th><th width="200"><p style="text-align:center">意见内容</p></th>
</th><th width="200"><p style="text-align:center">发表意见时间</p></th>
<th width="30"><p style="text-align:center">操作</p></th>
</tr>
<?php if(is_array($sview["list"])): foreach($sview["list"] as $key=>$v): ?><td><?php echo ($v["scomment"]); ?></td>
<td><p style="text-align:center"><?php echo ($v["stime"]); ?></p></td>
<td class="center">
<a href="/newTeacher/Kindergarten/Sview/del/sid/<?php echo ($v["sid"]); ?>">删除</a></td></tr><?php endforeach; endif; ?>
</table>
<div class="pagelist"><?php echo ($goods["page"]); ?></div>
</div>
<script>
$("select").change(function(){
	windows.location.href="/newTeacher/Kindergarten/Sview/index/"+$(this).val();
});
$(function(){
	$("tr:odd").addClass("odd");
});
