...
<body>
<div class="title">园长个人信息修改页面</div>
<div class="data-edit clear">
<form method="post" enctype="multipart/form-data">
<table>
<tr><th>姓名：</th><td><input type="text" name="name" value="<?php echo ($kindergarten["name"]); ?>" /></td></tr>
<tr><th>密码：</th><td><input type="text" name="password" value="<?php echo ($kindergarten["password"]); ?>"/></td></tr>
<tr><th>性别：</th><td><input type="text" name="sex" value="<?php echo ($kindergarten["sex"]); ?>" /></td></tr>
<tr><th>联系方式：</th><td><input type="text" name="phonenum" value="<?php echo ($kindergarten["phonenum"]); ?>" /></td></tr>
