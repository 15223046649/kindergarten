...
<body>
<div class="title">教职工信息添加</div>
<div class="data-edit clear">
<form method="post" enctype="multipart/form-data">
<table>
<tr><th>教师ID：</th><td><input type="text" name="Teacher_ID"/></td></tr>
<tr><th>教师_PWD：</th><td><input type="text" name="Teacher_PWD"/></td></tr>
<tr><th>教师姓名：</th><td><input type="text" name="Teacher_NAME"></td></tr>
<tr><th>教师性别：</th><td><input type="text" name="Teacher_SEX" /></td></tr>
<tr><th>任教班级：</th><td><input type="text" name="Teacher_CLA" /></td></tr>
