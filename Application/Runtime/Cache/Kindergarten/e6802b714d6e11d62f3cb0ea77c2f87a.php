...
<body>
<h3 style="text-align:left">教师意见表</h3>
<form method="post" enctype="multipart/form-data" style="align:center">
<table  border="1" cellspacing="0px" >
<th width="200"><p style="text-align:center">意见内容</p></th>
<th width="200"><p style="text-align:center">发表意见时间</p></th>
<th width="30"><p style="text-align:center">操作</p></th>
</tr>
<?php if(is_array($tview["list"])): foreach($tview["list"] as $key=>$v): ?><td><?php echo ($v["comment"]); ?></td>
<td><p style="text-align:center"><?php echo ($v["ttime"]); ?></p></td>
<td class="center">
<a href="/newTeacher/Kindergarten/Tview/del/id/<?php echo ($v["id"]); ?>">删除</a></td></tr><?php endforeach; endif; ?>
</table>
<div class="pagelist"><?php echo ($goods["page"]); ?></div>
</div>
<script>
$("select").change(function(){
	windows.location.href="/newTeacher/Kindergarten/Tview/index/"+$(this).val();
});
$(function(){
	$("tr:odd").addClass("odd");
});
