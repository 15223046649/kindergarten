...
<div id="main">
	...
	<div id="content">
		<div class="item"><div class="title">园长通知</div>
<div class="title-btn left"></div>
<div class="data-list clear">
	<table border="0">
		...
		<?php if(is_array($snotice["list"])): foreach($snotice["list"] as $key=>$v): ?><tr><td><?php echo ($v["id"]); ?></td>
			<td><?php echo ($v["stitle"]); ?></td>
			<td class="center"><?php echo ($v["scomment"]); ?></td>
			<td class="center"><?php echo ($v["stime"]); ?></td>
			</tr><?php endforeach; endif; ?>
	</table>
	<div class="pagelist"><?php echo ($snotice["page"]); ?></div>
</div>
</div>
	</div>
</div>
