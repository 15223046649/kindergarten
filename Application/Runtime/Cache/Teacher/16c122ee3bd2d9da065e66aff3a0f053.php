...
<div id="main">
	...
	<div id="content">
		<div class="item"><div class="title">已发布通知</div>
<div class="data-list clear">
	<table border="1">
		<tr><th width="50">通知主题</th><th width="120">内容</th><th width="80">发布时间</th><th width="50">操作</th></tr>
		<?php if(is_array($message["list"])): foreach($message["list"] as $key=>$v): ?><tr><td><?php echo ($v["theme"]); ?></td>
			<td><?php echo ($v["comment"]); ?></td>
			<td><?php echo ($v["time"]); ?></td>
			<td class="center"><a href="<?php echo U('delete?id='.$v['id']);?>" onclick="return confirm('确定删除吗？')">删除</a>
			<a href="<?php echo U('revise?id='.$v['id']);?>">| 修改</a></td>
