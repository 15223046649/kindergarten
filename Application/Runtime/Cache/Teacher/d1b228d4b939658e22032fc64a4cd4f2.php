...
<div id="main">
	...
	<div id="content">
		<div class="item"><div class="title">查看通知</div>
<div class="data-list clear">
	<table border="1">
		<tr><th width="80">通知主题</th><th width="120">内容</th><th width="80">发布时间</th></tr>
		<?php if(is_array($notice["list"])): foreach($notice["list"] as $key=>$v): ?><tr><td><?php echo ($v["topic"]); ?></td>
			<td><?php echo ($v["comment"]); ?></td>
			<td><?php echo ($v["time"]); ?></td><?php endforeach; endif; ?>
	</table>
	<div class="pagelist"><?php echo ($notice["page"]); ?></div>
</div></div>
	</div>
</div>
<script>
