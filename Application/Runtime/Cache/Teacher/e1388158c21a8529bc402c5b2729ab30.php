...
<div id="main">
	...
	<div id="content">
		<div class="item"><div class="title">修改通知</div>
<div class="data-edit clear">
<form method="post" action="/newTeacher/Teacher/Message/do_revise">
<input  type="hidden" name="id"/>
	<table>
		<tr><td>通知主题</td><td>
    <input type="text" name="theme" id="theme" value=""></td></tr>
    <tr><td>通知内容</td><td>
    <textarea name="comment" id="comment"></textarea></td></tr>
			<tr><td>&nbsp;</td><td><input style="width:50px;" type="submit" value="修  改" /></td></tr>
	</table>
	</form>
</div></div>
	</div>
